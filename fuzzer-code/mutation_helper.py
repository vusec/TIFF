...
values_32bit  = [{'value':'\x00\x00\x00\x00', 'type':'replace', 'size':4}, {'value':'\x00\x00\x00\x01','type':'replace', 'size':4}, {'value':'\x7f\xff\xff\xef', 'type':'replace', 'size':4}, 
                {'value':'\x7f\xff\xff\xfe',  'type':'replace', 'size':4}, {'value':'\x7f\xff\xff\xff','type':'replace', 'size':4}, {'value':'\x80\x00\x00\x00',  'type':'replace', 'size':4}, 
                {'value':'\x80\x00\x00\x0f', 'type':'replace', 'size':4}, {'value':'\xff\xff\xff\xfe', 'type':'replace', 'size':4}, {'value':'\xff\xff\xff\xff'
,      'type':'replace', 'size':4} ]
